...
const SCHEDULE_TEMPLATES: ScheduleTemplate[] = [
  ...
  },
  {
    ...
    tasks: [
      // ── ROOT ──────────────────────────────────────────────────────────────────
      { localId: "root", phase: "Project", name: "Custom Home Build", durationDays: 540, offsetDays: 0 },

      // ── PRE-CONSTRUCTION (days 0–89) ─────────────────────────────────────────
      { localId: "precon", phase: "Pre-Construction", name: "Pre-Construction", durationDays: 90, offsetDays: 0, parentRef: "root" },
      { localId: "survey", phase: "Pre-Construction", name: "Survey & Soil Testing", durationDays: 7, offsetDays: 0, trade: "Civil", parentRef: "precon" },
      { localId: "arch-design", phase: "Pre-Construction", name: "Architectural Design & Plans", durationDays: 30, offsetDays: 0, parentRef: "precon" },
      { localId: "struct-eng", phase: "Pre-Construction", name: "Structural Engineering", durationDays: 21, offsetDays: 30, parentRef: "precon" },
      { localId: "mep-eng", phase: "Pre-Construction", name: "MEP Engineering", durationDays: 14, offsetDays: 30, trade: "Engineering", parentRef: "precon" },
      { localId: "selections", phase: "Pre-Construction", name: "Material & Finish Selections", durationDays: 30, offsetDays: 0, parentRef: "precon" },
      { localId: "permit-app", phase: "Pre-Construction", name: "Permit Application – Building", durationDays: 7, offsetDays: 51, parentRef: "precon" },
      { localId: "permit-review", phase: "Pre-Construction", name: "Permit Review & Approval", durationDays: 30, offsetDays: 58, parentRef: "precon" },
      { localId: "permit-issued", phase: "Pre-Construction", name: "Permit Issued", durationDays: 1, offsetDays: 89, isMilestone: true, parentRef: "precon" },

      // ── SITE WORK (days 90–119) ───────────────────────────────────────────────
      { localId: "sitework", phase: "Site Work", name: "Site Work", durationDays: 30, offsetDays: 90, parentRef: "root" },
      { localId: "site-clear", phase: "Site Work", name: "Site Clearing & Tree Removal", durationDays: 5, offsetDays: 90, trade: "Site Work", parentRef: "sitework" },
      { localId: "grading", phase: "Site Work", name: "Grading & Drainage Plan", durationDays: 7, offsetDays: 95, trade: "Site Work", parentRef: "sitework" },
      { localId: "ug-util", phase: "Site Work", name: "Underground Utilities – Water, Sewer, Electric", durationDays: 10, offsetDays: 95, trade: "Site Work", parentRef: "sitework" },
      { localId: "temp-power", phase: "Site Work", name: "Temporary Power & Facilities", durationDays: 3, offsetDays: 90, parentRef: "sitework" },

      // ── FOUNDATION (days 110–154) ─────────────────────────────────────────────
      { localId: "foundation", phase: "Foundation", name: "Foundation", durationDays: 45, offsetDays: 110, parentRef: "root" },
      { localId: "layout", phase: "Foundation", name: "Layout & Excavation", durationDays: 5, offsetDays: 110, trade: "Concrete", parentRef: "foundation" },
      { localId: "footings", phase: "Foundation", name: "Footings – Form & Pour", durationDays: 7, offsetDays: 115, trade: "Concrete", parentRef: "foundation" },
      { localId: "slab-walls", phase: "Foundation", name: "Slab / Foundation Walls", durationDays: 10, offsetDays: 122, trade: "Concrete", parentRef: "foundation" },
      { localId: "waterproof", phase: "Foundation", name: "Waterproofing & Underslab Plumbing", durationDays: 5, offsetDays: 132, trade: "Concrete", parentRef: "foundation" },
      { localId: "slab-pour", phase: "Foundation", name: "Slab Pour & Cure", durationDays: 14, offsetDays: 137, trade: "Concrete", parentRef: "foundation" },
      { localId: "found-insp", phase: "Foundation", name: "Foundation Inspection", durationDays: 1, offsetDays: 153, isMilestone: true, parentRef: "foundation" },

      // ── FRAMING (days 154–219) ────────────────────────────────────────────────
      { localId: "framing", phase: "Framing", name: "Framing", durationDays: 66, offsetDays: 154, parentRef: "root" },
      { localId: "floor-sys", phase: "Framing", name: "Floor System & Plates", durationDays: 7, offsetDays: 154, trade: "Framing", parentRef: "framing" },
      { localId: "wall-frame", phase: "Framing", name: "Wall Framing – Exterior & Interior", durationDays: 14, offsetDays: 161, trade: "Framing", parentRef: "framing" },
      { localId: "roof-frame", phase: "Framing", name: "Roof Framing & Sheathing", durationDays: 14, offsetDays: 175, trade: "Framing", parentRef: "framing" },
      { localId: "win-rough", phase: "Framing", name: "Impact Windows & Doors – Rough Frame", durationDays: 7, offsetDays: 175, trade: "Windows", parentRef: "framing" },
      { localId: "sheathing", phase: "Framing", name: "Sheathing & House Wrap", durationDays: 5, offsetDays: 189, trade: "Framing", parentRef: "framing" },
      { localId: "frame-insp", phase: "Framing", name: "Framing Inspection", durationDays: 1, offsetDays: 219, isMilestone: true, parentRef: "framing" },

      // ── ROOFING & EXTERIOR (days 200–241) ────────────────────────────────────
      { localId: "roofing-ext", phase: "Roofing & Exterior", name: "Roofing & Exterior", durationDays: 42, offsetDays: 200, parentRef: "root" },
      { localId: "roofing", phase: "Roofing & Exterior", name: "Roofing – Underlayment & Tile", durationDays: 14, offsetDays: 200, trade: "Roofing", parentRef: "roofing-ext" },
      { localId: "win-final", phase: "Roofing & Exterior", name: "Impact Windows & Doors – Final Install", durationDays: 10, offsetDays: 200, trade: "Windows", parentRef: "roofing-ext" },
      { localId: "stucco", phase: "Roofing & Exterior", name: "Stucco / Exterior Cladding", durationDays: 14, offsetDays: 214, trade: "Stucco", parentRef: "roofing-ext" },
      { localId: "ext-paint", phase: "Roofing & Exterior", name: "Exterior Paint – Primer & 2 Coats", durationDays: 10, offsetDays: 228, trade: "Painter", parentRef: "roofing-ext" },
      { localId: "garage-doors", phase: "Roofing & Exterior", name: "Garage Doors & Entry", durationDays: 3, offsetDays: 238, trade: "Doors", parentRef: "roofing-ext" },

      // ── MEP ROUGH-IN (days 220–269) ───────────────────────────────────────────
      { localId: "mep-rough", phase: "MEP Rough-In", name: "MEP Rough-In", durationDays: 50, offsetDays: 220, parentRef: "root" },
      { localId: "elec-rough", phase: "MEP Rough-In", name: "Rough Electrical – Full House", durationDays: 14, offsetDays: 220, trade: "Electrical", parentRef: "mep-rough" },
      { localId: "plumb-rough", phase: "MEP Rough-In", name: "Rough Plumbing", durationDays: 14, offsetDays: 220, trade: "Plumbing", parentRef: "mep-rough" },
      { localId: "hvac-rough", phase: "MEP Rough-In", name: "HVAC Ductwork & Air Handler", durationDays: 14, offsetDays: 220, trade: "HVAC", parentRef: "mep-rough" },
      { localId: "sprinkler-rough", phase: "MEP Rough-In", name: "Fire Sprinkler Rough", durationDays: 10, offsetDays: 220, trade: "Fire Suppression", parentRef: "mep-rough" },
      { localId: "low-volt", phase: "MEP Rough-In", name: "Low Voltage – Data, Security, AV Rough", durationDays: 7, offsetDays: 234, trade: "Low Voltage", parentRef: "mep-rough" },
      { localId: "mep-rough-insp", phase: "MEP Rough-In", name: "Rough Inspections – MEP", durationDays: 1, offsetDays: 269, isMilestone: true, parentRef: "mep-rough" },

      // ── INSULATION & DRYWALL (days 270–314) ──────────────────────────────────
      { localId: "ins-dw", phase: "Insulation & Drywall", name: "Insulation & Drywall", durationDays: 45, offsetDays: 270, parentRef: "root" },
      { localId: "insulation", phase: "Insulation & Drywall", name: "Spray Foam / Batt Insulation", durationDays: 10, offsetDays: 270, trade: "Insulation", parentRef: "ins-dw" },
      { localId: "dw-hang", phase: "Insulation & Drywall", name: "Drywall Hang", durationDays: 14, offsetDays: 280, trade: "Drywall", parentRef: "ins-dw" },
      { localId: "dw-finish", phase: "Insulation & Drywall", name: "Drywall Finish – 3 Coats", durationDays: 14, offsetDays: 294, trade: "Drywall", parentRef: "ins-dw" },
      { localId: "dw-prime", phase: "Insulation & Drywall", name: "Drywall Prime & Texture", durationDays: 7, offsetDays: 308, trade: "Drywall", parentRef: "ins-dw" },

      // ── INTERIOR FINISHES (days 315–459) ─────────────────────────────────────
      { localId: "int-fin", phase: "Interior Finishes", name: "Interior Finishes", durationDays: 145, offsetDays: 315, parentRef: "root" },
      { localId: "int-paint", phase: "Interior Finishes", name: "Interior Paint – Full House", durationDays: 21, offsetDays: 315, trade: "Painter", parentRef: "int-fin" },
      { localId: "flooring", phase: "Interior Finishes", name: "Flooring – Tile & Wood", durationDays: 21, offsetDays: 315, trade: "Flooring", parentRef: "int-fin" },
      { localId: "cabinets", phase: "Interior Finishes", name: "Kitchen Cabinets & Island", durationDays: 14, offsetDays: 336, trade: "Carpenter", parentRef: "int-fin" },
      { localId: "countertops", phase: "Interior Finishes", name: "Countertops – Template & Fabrication", durationDays: 14, offsetDays: 350, trade: "Countertops", parentRef: "int-fin" },
      { localId: "backsplash", phase: "Interior Finishes", name: "Kitchen Backsplash & Bath Tile", durationDays: 14, offsetDays: 336, trade: "Tile", parentRef: "int-fin" },
      { localId: "trim", phase: "Interior Finishes", name: "Interior Doors, Trim & Millwork", durationDays: 21, offsetDays: 336, trade: "Carpenter", parentRef: "int-fin" },
      { localId: "closets", phase: "Interior Finishes", name: "Closet Systems & Built-Ins", durationDays: 10, offsetDays: 357, trade: "Carpenter", parentRef: "int-fin" },
      { localId: "shower-glass", phase: "Interior Finishes", name: "Shower Glass Enclosures", durationDays: 7, offsetDays: 367, trade: "Glass", parentRef: "int-fin" },
      { localId: "stairs", phase: "Interior Finishes", name: "Stairs & Railings", durationDays: 10, offsetDays: 357, trade: "Carpenter", parentRef: "int-fin" },

      // ── FINAL MEP & FIXTURES (days 390–449) ──────────────────────────────────
      { localId: "final-mep", phase: "Final MEP & Fixtures", name: "Final MEP & Fixtures", durationDays: 35, offsetDays: 390, parentRef: "root" },
      { localId: "elec-final", phase: "Final MEP & Fixtures", name: "Final Electrical – Devices & Fixtures", durationDays: 14, offsetDays: 390, trade: "Electrical", parentRef: "final-mep" },
      { localId: "plumb-final", phase: "Final MEP & Fixtures", name: "Final Plumbing – Fixtures & Trim", durationDays: 10, offsetDays: 390, trade: "Plumbing", parentRef: "final-mep" },
      { localId: "hvac-final", phase: "Final MEP & Fixtures", name: "HVAC Final & Balancing", durationDays: 7, offsetDays: 390, trade: "HVAC", parentRef: "final-mep" },
      { localId: "low-volt-final", phase: "Final MEP & Fixtures", name: "Low Voltage – Terminations & Programming", durationDays: 7, offsetDays: 404, trade: "Low Voltage", parentRef: "final-mep" },
      { localId: "appliances", phase: "Final MEP & Fixtures", name: "Appliance Installation", durationDays: 5, offsetDays: 411, trade: "Appliances", parentRef: "final-mep" },
      { localId: "sprinkler-final", phase: "Final MEP & Fixtures", name: "Fire Sprinkler Final", durationDays: 3, offsetDays: 411, trade: "Fire Suppression", parentRef: "final-mep" },

      // ── LANDSCAPING & SITE (days 430–455) ────────────────────────────────────
      { localId: "landscape", phase: "Landscaping & Site", name: "Landscaping & Site", durationDays: 26, offsetDays: 430, parentRef: "root" },
      { localId: "driveway", phase: "Landscaping & Site", name: "Driveway & Walkways", durationDays: 7, offsetDays: 430, trade: "Concrete", parentRef: "landscape" },
      { localId: "sod", phase: "Landscaping & Site", name: "Landscaping & Sod", durationDays: 14, offsetDays: 437, trade: "Landscaping", parentRef: "landscape" },
      { localId: "irrigation", phase: "Landscaping & Site", name: "Irrigation System", durationDays: 7, offsetDays: 437, trade: "Landscaping", parentRef: "landscape" },
      { localId: "fence", phase: "Landscaping & Site", name: "Fence & Gate", durationDays: 5, offsetDays: 451, trade: "Fence", parentRef: "landscape" },

      // ── CLOSEOUT (days 490–539) ───────────────────────────────────────────────
      { localId: "closeout", phase: "Closeout", name: "Closeout", durationDays: 50, offsetDays: 490, parentRef: "root" },
      { localId: "mep-final-insp", phase: "Closeout", name: "Final MEP Inspections", durationDays: 1, offsetDays: 490, isMilestone: true, parentRef: "closeout" },
      { localId: "bldg-insp", phase: "Closeout", name: "Final Building Inspection", durationDays: 1, offsetDays: 500, isMilestone: true, parentRef: "closeout" },
      { localId: "co", phase: "Closeout", name: "Certificate of Occupancy", durationDays: 1, offsetDays: 515, isMilestone: true, parentRef: "closeout" },
      { localId: "punchlist", phase: "Closeout", name: "Punch List", durationDays: 14, offsetDays: 516, parentRef: "closeout" },
      { localId: "clean", phase: "Closeout", name: "Deep Clean & Final Walkthrough", durationDays: 3, offsetDays: 530, parentRef: "closeout" },
      { localId: "movein", phase: "Closeout", name: "Move-In Ready", durationDays: 1, offsetDays: 539, isMilestone: true, parentRef: "closeout" },
    ],
  },
  {
    id: "custom-home-24",
    ...
    tasks: [
      // ── ROOT ──────────────────────────────────────────────────────────────────
      { localId: "root", phase: "Project", name: "Custom Luxury Home", durationDays: 720, offsetDays: 0 },

      // ── PRE-CONSTRUCTION (days 0–119) ─────────────────────────────────────────
      { localId: "precon", phase: "Pre-Construction", name: "Pre-Construction", durationDays: 120, offsetDays: 0, parentRef: "root" },
      { localId: "survey", phase: "Pre-Construction", name: "Survey, Soil & Environmental Testing", durationDays: 14, offsetDays: 0, trade: "Civil", parentRef: "precon" },
      { localId: "arch-sd", phase: "Pre-Construction", name: "Architectural Design – Schematic", durationDays: 30, offsetDays: 0, parentRef: "precon" },
      { localId: "arch-dd", phase: "Pre-Construction", name: "Architectural Design – Design Development", durationDays: 30, offsetDays: 30, parentRef: "precon" },
      { localId: "arch-cd", phase: "Pre-Construction", name: "Architectural Construction Documents", durationDays: 21, offsetDays: 60, parentRef: "precon" },
      { localId: "struct-eng", phase: "Pre-Construction", name: "Structural & Civil Engineering", durationDays: 30, offsetDays: 45, parentRef: "precon" },
      { localId: "mep-eng", phase: "Pre-Construction", name: "MEP Engineering", durationDays: 21, offsetDays: 60, trade: "Engineering", parentRef: "precon" },
      { localId: "selections", phase: "Pre-Construction", name: "Interior Design & Finish Selections", durationDays: 60, offsetDays: 0, parentRef: "precon" },
      { localId: "permit-app", phase: "Pre-Construction", name: "Permit Application – Full Package", durationDays: 7, offsetDays: 81, parentRef: "precon" },
      { localId: "permit-review", phase: "Pre-Construction", name: "Permit Review, Revisions & Resubmittal", durationDays: 30, offsetDays: 88, parentRef: "precon" },
      { localId: "permit-issued", phase: "Pre-Construction", name: "Permit Issued", durationDays: 1, offsetDays: 119, isMilestone: true, parentRef: "precon" },

      // ── SITE WORK (days 120–159) ───────────────────────────────────────────────
      { localId: "sitework", phase: "Site Work", name: "Site Work", durationDays: 40, offsetDays: 120, parentRef: "root" },
      { localId: "site-clear", phase: "Site Work", name: "Site Clearing, Grading & Tree Removal", durationDays: 7, offsetDays: 120, trade: "Site Work", parentRef: "sitework" },
      { localId: "ug-util", phase: "Site Work", name: "Underground Utilities – Water, Sewer, Electric, Gas", durationDays: 14, offsetDays: 127, trade: "Site Work", parentRef: "sitework" },
      { localId: "retaining", phase: "Site Work", name: "Retaining Walls & Site Grading", durationDays: 14, offsetDays: 127, trade: "Civil", parentRef: "sitework" },
      { localId: "temp-power", phase: "Site Work", name: "Temporary Power & Site Setup", durationDays: 3, offsetDays: 120, parentRef: "sitework" },

      // ── FOUNDATION (days 155–219) ─────────────────────────────────────────────
      { localId: "foundation", phase: "Foundation", name: "Foundation", durationDays: 65, offsetDays: 155, parentRef: "root" },
      { localId: "layout", phase: "Foundation", name: "Layout, Excavation & Piling", durationDays: 10, offsetDays: 155, trade: "Concrete", parentRef: "foundation" },
      { localId: "footings", phase: "Foundation", name: "Deep Footings & Grade Beams", durationDays: 14, offsetDays: 165, trade: "Concrete", parentRef: "foundation" },
      { localId: "underslab", phase: "Foundation", name: "Underslab Plumbing & Conduit", durationDays: 7, offsetDays: 165, trade: "Plumbing", parentRef: "foundation" },
      { localId: "stemwalls", phase: "Foundation", name: "Stem Walls & Waterproofing", durationDays: 10, offsetDays: 179, trade: "Concrete", parentRef: "foundation" },
      { localId: "slab-pour", phase: "Foundation", name: "Slab – Form, Rebar, Pour & Cure", durationDays: 21, offsetDays: 189, trade: "Concrete", parentRef: "foundation" },
      { localId: "found-insp", phase: "Foundation", name: "Foundation Inspection", durationDays: 1, offsetDays: 219, isMilestone: true, parentRef: "foundation" },

      // ── FRAMING (days 220–349) ────────────────────────────────────────────────
      { localId: "framing", phase: "Framing", name: "Framing", durationDays: 130, offsetDays: 220, parentRef: "root" },
      { localId: "floor1", phase: "Framing", name: "First Floor Framing", durationDays: 21, offsetDays: 220, trade: "Framing", parentRef: "framing" },
      { localId: "floor2", phase: "Framing", name: "Second Floor Deck & Framing", durationDays: 21, offsetDays: 241, trade: "Framing", parentRef: "framing" },
      { localId: "roof-frame", phase: "Framing", name: "Roof Framing – Complex Hip / Trusses", durationDays: 21, offsetDays: 262, trade: "Framing", parentRef: "framing" },
      { localId: "roof-sheath", phase: "Framing", name: "Roof Sheathing & Weather Barrier", durationDays: 7, offsetDays: 283, trade: "Framing", parentRef: "framing" },
      { localId: "win-rough", phase: "Framing", name: "Impact Windows & Doors – Rough Frame", durationDays: 14, offsetDays: 262, trade: "Windows", parentRef: "framing" },
      { localId: "sheathing", phase: "Framing", name: "Sheathing, Bracing & Fastening", durationDays: 10, offsetDays: 290, trade: "Framing", parentRef: "framing" },
      { localId: "frame-insp", phase: "Framing", name: "Framing Inspection", durationDays: 1, offsetDays: 349, isMilestone: true, parentRef: "framing" },

      // ── ROOFING & EXTERIOR (days 300–399) ────────────────────────────────────
      { localId: "roofing-ext", phase: "Roofing & Exterior", name: "Roofing & Exterior", durationDays: 100, offsetDays: 300, parentRef: "root" },
      { localId: "roofing", phase: "Roofing & Exterior", name: "Roofing – Tile / Metal / Flat Sections", durationDays: 21, offsetDays: 300, trade: "Roofing", parentRef: "roofing-ext" },
      { localId: "skylights", phase: "Roofing & Exterior", name: "Skylights & Roof Penetrations", durationDays: 5, offsetDays: 321, trade: "Roofing", parentRef: "roofing-ext" },
      { localId: "win-final", phase: "Roofing & Exterior", name: "Impact Windows & Doors – Final Install", durationDays: 14, offsetDays: 300, trade: "Windows", parentRef: "roofing-ext" },
      { localId: "stucco", phase: "Roofing & Exterior", name: "Stucco – Scratch, Brown & Finish Coat", durationDays: 21, offsetDays: 321, trade: "Stucco", parentRef: "roofing-ext" },
      { localId: "ext-paint", phase: "Roofing & Exterior", name: "Exterior Paint – Primer & 2 Coats", durationDays: 14, offsetDays: 342, trade: "Painter", parentRef: "roofing-ext" },
      { localId: "balconies", phase: "Roofing & Exterior", name: "Balconies, Railings & Exterior Metal", durationDays: 10, offsetDays: 342, trade: "Ironwork", parentRef: "roofing-ext" },
      { localId: "garage-doors", phase: "Roofing & Exterior", name: "Garage Doors & Entry Gates", durationDays: 5, offsetDays: 356, trade: "Doors", parentRef: "roofing-ext" },

      // ── MEP ROUGH-IN (days 350–419) ───────────────────────────────────────────
      { localId: "mep-rough", phase: "MEP Rough-In", name: "MEP Rough-In", durationDays: 70, offsetDays: 350, parentRef: "root" },
      { localId: "elec-rough", phase: "MEP Rough-In", name: "Rough Electrical – Full House (2 Floors)", durationDays: 21, offsetDays: 350, trade: "Electrical", parentRef: "mep-rough" },
      { localId: "plumb-rough", phase: "MEP Rough-In", name: "Rough Plumbing – All Baths & Kitchen", durationDays: 21, offsetDays: 350, trade: "Plumbing", parentRef: "mep-rough" },
      { localId: "hvac-rough", phase: "MEP Rough-In", name: "HVAC Ductwork, Zones & Air Handlers", durationDays: 21, offsetDays: 350, trade: "HVAC", parentRef: "mep-rough" },
      { localId: "sprinkler-rough", phase: "MEP Rough-In", name: "Fire Sprinkler Rough", durationDays: 14, offsetDays: 350, trade: "Fire Suppression", parentRef: "mep-rough" },
      { localId: "gen-rough", phase: "MEP Rough-In", name: "Generator & Transfer Switch Rough", durationDays: 7, offsetDays: 364, trade: "Electrical", parentRef: "mep-rough" },
      { localId: "low-volt", phase: "MEP Rough-In", name: "Low Voltage – Data, Security, AV, Smart Home", durationDays: 14, offsetDays: 371, trade: "Low Voltage", parentRef: "mep-rough" },
      { localId: "gas-rough", phase: "MEP Rough-In", name: "Gas Piping Rough", durationDays: 7, offsetDays: 371, trade: "Plumbing", parentRef: "mep-rough" },
      { localId: "mep-rough-insp", phase: "MEP Rough-In", name: "Rough Inspections – MEP", durationDays: 1, offsetDays: 419, isMilestone: true, parentRef: "mep-rough" },

      // ── INSULATION & DRYWALL (days 420–496) ──────────────────────────────────
      { localId: "ins-dw", phase: "Insulation & Drywall", name: "Insulation & Drywall", durationDays: 77, offsetDays: 420, parentRef: "root" },
      { localId: "spray-foam", phase: "Insulation & Drywall", name: "Spray Foam Insulation – Roof Deck & Walls", durationDays: 14, offsetDays: 420, trade: "Insulation", parentRef: "ins-dw" },
      { localId: "batt-ins", phase: "Insulation & Drywall", name: "Batt Insulation – Interior Walls", durationDays: 7, offsetDays: 434, trade: "Insulation", parentRef: "ins-dw" },
      { localId: "dw-hang", phase: "Insulation & Drywall", name: "Drywall Hang – Both Floors", durationDays: 21, offsetDays: 441, trade: "Drywall", parentRef: "ins-dw" },
      { localId: "dw-finish", phase: "Insulation & Drywall", name: "Drywall Finish – 3 Coats", durationDays: 21, offsetDays: 462, trade: "Drywall", parentRef: "ins-dw" },
      { localId: "dw-prime", phase: "Insulation & Drywall", name: "Drywall Prime & Skim Coat", durationDays: 14, offsetDays: 483, trade: "Drywall", parentRef: "ins-dw" },

      // ── INTERIOR FINISHES (days 497–629) ─────────────────────────────────────
      { localId: "int-fin", phase: "Interior Finishes", name: "Interior Finishes", durationDays: 133, offsetDays: 497, parentRef: "root" },
      { localId: "int-paint", phase: "Interior Finishes", name: "Interior Paint – Full House, All Floors", durationDays: 28, offsetDays: 497, trade: "Painter", parentRef: "int-fin" },
      { localId: "flooring", phase: "Interior Finishes", name: "Flooring – Marble, Wood & Tile", durationDays: 28, offsetDays: 497, trade: "Flooring", parentRef: "int-fin" },
      { localId: "cabinets", phase: "Interior Finishes", name: "Kitchen Cabinets – Custom", durationDays: 21, offsetDays: 525, trade: "Carpenter", parentRef: "int-fin" },
      { localId: "countertops", phase: "Interior Finishes", name: "Countertops – Custom Stone Fabrication", durationDays: 21, offsetDays: 546, trade: "Countertops", parentRef: "int-fin" },
      { localId: "backsplash", phase: "Interior Finishes", name: "Kitchen Backsplash – Custom Tile", durationDays: 14, offsetDays: 525, trade: "Tile", parentRef: "int-fin" },
      { localId: "bath-tile", phase: "Interior Finishes", name: "Bath Tile – All Baths", durationDays: 21, offsetDays: 525, trade: "Tile", parentRef: "int-fin" },
      { localId: "millwork", phase: "Interior Finishes", name: "Custom Millwork – Trim, Coffered Ceilings, Wainscoting", durationDays: 28, offsetDays: 525, trade: "Carpenter", parentRef: "int-fin" },
      { localId: "stairs", phase: "Interior Finishes", name: "Stairs, Railings & Balustrades", durationDays: 14, offsetDays: 553, trade: "Carpenter", parentRef: "int-fin" },
      { localId: "closets", phase: "Interior Finishes", name: "Closet Systems & Walk-In Wardrobes", durationDays: 14, offsetDays: 553, trade: "Carpenter", parentRef: "int-fin" },
      { localId: "builtins", phase: "Interior Finishes", name: "Custom Built-Ins & Entertainment Center", durationDays: 14, offsetDays: 553, trade: "Carpenter", parentRef: "int-fin" },
      { localId: "shower-glass", phase: "Interior Finishes", name: "Shower Glass – Frameless Enclosures", durationDays: 10, offsetDays: 567, trade: "Glass", parentRef: "int-fin" },
      { localId: "spec-ceil", phase: "Interior Finishes", name: "Specialty Ceilings – Plaster / Tray", durationDays: 14, offsetDays: 553, trade: "Drywall", parentRef: "int-fin" },

      // ── FINAL MEP & FIXTURES (days 580–622) ──────────────────────────────────
      { localId: "final-mep", phase: "Final MEP & Fixtures", name: "Final MEP & Fixtures", durationDays: 43, offsetDays: 580, parentRef: "root" },
      { localId: "elec-final", phase: "Final MEP & Fixtures", name: "Final Electrical – Devices, Fixtures & Panel", durationDays: 14, offsetDays: 580, trade: "Electrical", parentRef: "final-mep" },
      { localId: "plumb-final", phase: "Final MEP & Fixtures", name: "Final Plumbing – Fixtures & Trim", durationDays: 14, offsetDays: 580, trade: "Plumbing", parentRef: "final-mep" },
      { localId: "hvac-final", phase: "Final MEP & Fixtures", name: "HVAC Final & Balancing", durationDays: 10, offsetDays: 580, trade: "HVAC", parentRef: "final-mep" },
      { localId: "gen-final", phase: "Final MEP & Fixtures", name: "Generator Install & Commissioning", durationDays: 7, offsetDays: 594, trade: "Electrical", parentRef: "final-mep" },
      { localId: "smart-home", phase: "Final MEP & Fixtures", name: "Smart Home / AV System Setup", durationDays: 14, offsetDays: 594, trade: "Low Voltage", parentRef: "final-mep" },
      { localId: "appliances", phase: "Final MEP & Fixtures", name: "Premium Appliance Installation", durationDays: 7, offsetDays: 608, trade: "Appliances", parentRef: "final-mep" },
      { localId: "sprinkler-final", phase: "Final MEP & Fixtures", name: "Fire Sprinkler Final", durationDays: 3, offsetDays: 608, trade: "Fire Suppression", parentRef: "final-mep" },
      { localId: "lighting", phase: "Final MEP & Fixtures", name: "Custom Lighting Fixtures", durationDays: 7, offsetDays: 615, trade: "Electrical", parentRef: "final-mep" },

      // ── POOL & OUTDOOR LIVING (days 580–652) ─────────────────────────────────
      { localId: "pool-outdoor", phase: "Pool & Outdoor Living", name: "Pool & Outdoor Living", durationDays: 73, offsetDays: 580, parentRef: "root" },
      { localId: "pool-shell", phase: "Pool & Outdoor Living", name: "Pool / Spa Excavation & Shell", durationDays: 21, offsetDays: 580, trade: "Pool", parentRef: "pool-outdoor" },
      { localId: "pool-plumb", phase: "Pool & Outdoor Living", name: "Pool Plumbing & Equipment", durationDays: 14, offsetDays: 601, trade: "Pool", parentRef: "pool-outdoor" },
      { localId: "pool-tile", phase: "Pool & Outdoor Living", name: "Pool Tile & Coping", durationDays: 10, offsetDays: 615, trade: "Pool", parentRef: "pool-outdoor" },
      { localId: "outdoor-kitchen", phase: "Pool & Outdoor Living", name: "Outdoor Kitchen & Summer Kitchen", durationDays: 14, offsetDays: 594, trade: "Outdoor", parentRef: "pool-outdoor" },
      { localId: "driveway", phase: "Pool & Outdoor Living", name: "Driveway, Pavers & Walkways", durationDays: 14, offsetDays: 594, trade: "Concrete", parentRef: "pool-outdoor" },
      { localId: "landscape", phase: "Pool & Outdoor Living", name: "Landscaping, Sod & Irrigation", durationDays: 21, offsetDays: 625, trade: "Landscaping", parentRef: "pool-outdoor" },
      { localId: "fence", phase: "Pool & Outdoor Living", name: "Fence, Gate & Security Perimeter", durationDays: 7, offsetDays: 646, trade: "Fence", parentRef: "pool-outdoor" },

      // ── CLOSEOUT (days 660–719) ───────────────────────────────────────────────
      { localId: "closeout", phase: "Closeout", name: "Closeout", durationDays: 60, offsetDays: 660, parentRef: "root" },
      { localId: "mep-final-insp", phase: "Closeout", name: "Final MEP Inspections", durationDays: 1, offsetDays: 660, isMilestone: true, parentRef: "closeout" },
      { localId: "bldg-insp", phase: "Closeout", name: "Final Building Inspection", durationDays: 1, offsetDays: 672, isMilestone: true, parentRef: "closeout" },
      { localId: "pool-insp", phase: "Closeout", name: "Pool Final Inspection", durationDays: 1, offsetDays: 672, isMilestone: true, parentRef: "closeout" },
      { localId: "co", phase: "Closeout", name: "Certificate of Occupancy", durationDays: 1, offsetDays: 690, isMilestone: true, parentRef: "closeout" },
      { localId: "punchlist", phase: "Closeout", name: "Punch List", durationDays: 21, offsetDays: 691, parentRef: "closeout" },
      { localId: "clean", phase: "Closeout", name: "Final Detail Clean", durationDays: 5, offsetDays: 712, parentRef: "closeout" },
      { localId: "movein", phase: "Closeout", name: "Client Walkthrough & Move-In Ready", durationDays: 1, offsetDays: 719, isMilestone: true, parentRef: "closeout" },
    ],
  },
  {
    id: "commercial",
