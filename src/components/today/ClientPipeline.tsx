...
import { type PipelineStage, BASE_STAGES, loadStages, saveCustomStage, saveStageOrder, STAGE_COLORS } from "@/lib/pipelineStages";
              ...
              >
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 6, flex: 1, minWidth: 0 }}>
                    <span style={{ color: "#484f58", fontSize: 10, cursor: "grab", lineHeight: 1, flexShrink: 0 }} title="Drag to reorder">⠿</span>
                    <span
                      style={{
                        color: "#e6edf3",
                        fontWeight: 700,
          ...
          {showAddStage ? (
            <div style={{ background: "#161b22", border: "1px solid #30373f", borderRadius: 12, padding: 14 }}>
              ...
              <input
                ...
                style={{
                  ...
                  padding: "6px 8px", fontSize: 12, marginBottom: 10,
                  boxSizing: "border-box",
                }}
              />
              ...
              {/* Preview */}
              <div style={{
                borderTop: `3px solid ${newStageColor}`, borderRadius: "6px 6px 0 0",
                padding: "6px 8px", background: "#1e2736", marginBottom: 10,
              }}>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                (e.currentTarget as HTMLButtonElement).style.borderColor = "#C9A84C66";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLButtonElement).style.color = "#8b949e";
                (e.currentTarget as HTMLButtonElement).style.borderColor = "#30373f";
