...
function ItemRow({ item, index, lineNum }: { item: Item; index: number; lineNum?: number }) {
  ...
  return (
    <View wrap={false} minPresenceAhead={60} style={{ borderBottomWidth: 1, borderBottomColor: "#f1f5f9", backgroundColor: index % 2 === 0 ? undefined : "#fafafa" }}>
          ...
          return (
            <View key={gi}>
              ...
              {filteredDivs.map(({ div, filledItems, filledGroups }) => {
                ...
                return (
                  <View key={div.id} minPresenceAhead={280}>
